...
const subjects = ['All subjects', 'Data Structures and Algorithm', 'Advanced JAVA'];
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <StatCard
            icon={<Trophy size={20} />}
            title="Current Rank"
            value={`#${mockOverallStats.currentRank}`}
            bgColor="bg-qc-dark"
          />
          <StatCard
            icon={<FileText size={20} />}
            title="Total Exams"
            value={mockOverallStats.totalExams}
            bgColor="bg-qc-dark"
          />
          <StatCard
            icon={<CheckCircle size={20} />}
            title="Total Qns. Solved"
            value={mockOverallStats.totalQuestionsSolved}
            bgColor="bg-qc-dark"
          />
        </div>
      </div>
